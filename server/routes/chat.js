...
FORMATTING: Displayed in a narrow chat popup (~440px). Keep tables to 2 columns max. For 3+ attributes, use a bulleted list instead of a table. Do not use emoji characters — use plain text, markdown, and standard symbols (→, $, %, >, -) instead.`;
